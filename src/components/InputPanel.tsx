    ...
    >
      ...
      <div className="input-panel-scrollbar flex-1 overflow-y-auto space-y-4 pr-1">
        ...
        <div>
          ...
          <button
            onClick={onRunQuery}
            className="mt-2 w-full py-2 rounded-lg text-sm font-medium panel hover:opacity-80 transition-opacity flex items-center justify-center gap-1.5"
          >
      ...
      {onOpenGuide && (
        <div className="pt-2 border-t border-slate-200 dark:border-slate-800 shrink-0 flex items-center justify-between">
          <button
            type="button"
            onClick={onOpenGuide}
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors border border-slate-200 dark:border-slate-700"
